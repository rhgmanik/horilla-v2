...
def white_labelling_company(request):
    ...
    if white_labelling:
        ...
        company_name = company.company if company else "Dahinta"
        parts = company_name.split() if company_name else []
        company_name_first = parts[0] if parts else "Dahinta"
        return {
            "white_label_company_name": company_name_first,
            "white_label_company": company,
        }
    else:
        return {
            "white_label_company_name": "Dahinta",
